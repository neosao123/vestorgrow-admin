...
import CategoryService from "../../services/WebinarCategoryService";
...
function WebinarCategory() {
  ...
  const renderButtons = (row) => {
    return (
      <div className="updates_icon p-0">
        <Link to={`/webinar_create_category/${row._id}`} className="editIconCustom fa-sharp me-1 fa-solid fa-pen-to-square" >
  ...
  return (
    ...
    >
      ...
      <LinkName
        heading="Publish/Manage - Webinar Category"
        image="/assets/images/icons/publish.svg"
        span="Add Category"
        link="/webinar_create_category"
      />
